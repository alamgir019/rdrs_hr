                    ...
                    <ContentTemplate>
                            ...
                            <table>
                                ...
                                <tr>
                                    <td class="textlevel">
                                        Religion :</td>
                                    <td colspan="2">
                                        <asp:DropDownList ID="ddlReligion" runat="server" CssClass="textlevelleft" 
                                            Width="160px">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                        ...
                        <div id="holidayBottomForm">
                            ...
                            <div id="holidayBottomFormInner2">
                                <asp:GridView ID="grHoliday" runat="server" AutoGenerateColumns="False" DataKeyNames="HoliDayId,HolidayYear,HoliDesc,StartDate,IsFestival,ReligionId"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="IsFestival" HeaderText="Is Festival">
                                            <ItemStyle CssClass="ItemStylecssCenter" Width="10%" />
                                        </asp:BoundField>
