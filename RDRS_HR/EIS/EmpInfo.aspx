                        ...
                        <div style="float: left; width: 50%;">
                            <table>
                                <tr>
                                    ...
                                    <td style="width: 86px;" class="textlevel">
                                        Old Emp Id :</td>
                                    <td style="width: 86px;">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 30px">
                                            <asp:TextBox ID="txtFirstName" runat="server" MaxLength="50" Width="100px" 
                                                onchange="javascript:AddEmpName();" 
                                                ontextchanged="txtFirstName_TextChanged1"></asp:TextBox>
                                        </td>
                                        <td style="width: 11px">
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                ...
                                                <td>
                                                    <asp:DropDownList ID="ddlPrePS" runat="server" Width="155px" CssClass="textlevelleft"
                                                       >
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td class="textlevel" style="width: 65px;">
                                                    &nbsp;</td>
                                                <td>
                                                    <asp:CheckBox ID="chkSameAsPresent" runat="server" 
                                                         Text="Same as Present Address" AutoPostBack="True" 
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 158px">
                                        ...
                                        <asp:DropDownList ID="ddlSubject" runat="server" Width="127px" 
                                    CssClass="textlevelleft"></asp:DropDownList>
