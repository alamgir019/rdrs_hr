<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true"
    CodeFile="HomeDivision.aspx.cs" Inherits="HomeDivision" Title="Home Division" %>
...
<asp:Content ID="MainContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="setup">
        ...
        <div class="setupInner">
            <fieldset>
                ...
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" CssClass="textlevel" Text="Geo Division Name :"></asp:Label>
                        </td>
                        <td>
                            <asp:TextBox ID="txtDivision" runat="server" Width="309px"></asp:TextBox>
                        </td>
                        <td>
        ...
        <div class="GridFormat1">
            ...
            <asp:GridView ID="grDivision" runat="server" DataKeyNames="DivID,IsActive"
                AutoGenerateColumns="False" EmptyDataText="No Record Found" Font-Size="9px" Width="100%"
                OnRowCommand="grDivision_RowCommand">
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="DivName" HeaderText="District Name">
