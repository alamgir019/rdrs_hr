        ...
        <div class="officeSetupInner">
            <fieldset>
                ...
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" CssClass="textlevel" Text="Indicatir Type Titel :"></asp:Label>
                        </td>
                        <td colspan="3">
        ...
        <div class="GridFormat1">
            ...
            <asp:GridView ID="grIndicatirType" runat="server" DataKeyNames="IndTypeId" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="IndicatirTypeName" HeaderText="Indicatir Type">
