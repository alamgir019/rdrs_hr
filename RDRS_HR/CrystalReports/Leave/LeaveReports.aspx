                                                        ...
                                                        <asp:Panel ID="PDiv" runat="server" BorderStyle="Solid" BorderColor="DarkGray" BorderWidth="1px"
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="Label1" runat="server" Text="Division :" Width="80px" CssClass="textlevel"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                        ...
                                                        <asp:Panel ID="PSector" runat="server" BorderStyle="Solid" BorderColor="DarkGray"
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="Label8" runat="server" Text="Sector:" Width="80px" CssClass="textlevel"></asp:Label>
                                                                        </td>
                                                                        <td>
                                                        ...
                                                        <asp:Panel ID="PProgDept" runat="server" BorderStyle="Solid" BorderColor="DarkGray"
                                                            ...
                                                            <table>
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:Label ID="Label10" runat="server" Text="Program/Dept :" Width="80px"
                                                                                CssClass="textlevel"></asp:Label>
                                                                        </td>
                                                                        <td>
