        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                ...
                <div id="leaveApplicaionFormInner" style="margin-top: 5px;">
                    <cc1:TabContainer ID="TabContainer2" runat="server" ActiveTabIndex="0" Height="520px">
                            ...
                            <ContentTemplate>
                                <div style="background-color: #EFF3FB; border: solid 1px #3E506C;">
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label7" runat="server" CssClass="textlevel" Text="Employee ID : "
                                            ...
                                            <td>
                                                ...
                                                <asp:ImageButton ID="imgBtnSearch" runat="server" CausesValidation="False" Height="19px"
                                                    ImageUrl="~/Images/Search_Icon.jpg" OnClick="imgBtnSearch_Click" Width="21px">
                                                </asp:ImageButton>
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label2" runat="server" CssClass="textlevel" Text="Applicant : " Width="120px"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="lblName" runat="server" Width="600px"></asp:Label>
                                            </td>
                                            <td>
                                                <asp:Label ID="Label15" runat="server" CssClass="textlevel" Text="Supervisor :" Width="120px"></asp:Label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:Label ID="Label5" runat="server" CssClass="textlevel" Text="Leave Package : "
                                                    Width="120px"></asp:Label>
                                            </td>
                                            <td>
                                    ...
                                    <div style="width: 100%">
                                        <div style="width: 38%; float: left; background-color: #B8CCE4; border: solid 1px Gray;
                                            ...
                                            <table style="width: 100%">
                                                <tr>
                                                    <td style="font-size: 14px; font-weight: bold; text-align: left; border-bottom: solid 1px Gray;">
                                                        Check Leave Balance
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <div style="float: left; margin: 5px 0px 0px 5px; width: 98%; height: 325px;">
                                                            <asp:GridView ID="grLeaveStatus" runat="server" AutoGenerateColumns="False" DataKeyNames="EmpId,LTypeID,LTypeTitle,LCarryOverd,LEntitled,LCashed,LeaveEnjoyed,LeaveElapsed,lvOpening"
                                                                EmptyDataText="No Record Found" Font-Size="8px" OnSelectedIndexChanged="grLeaveStatus_SelectedIndexChanged"
                                        ...
                                        <div style="width: 29%; float: left; margin-left: 1%; background-color: #F2DBDB;
                                            border: solid 1px Gray; height: 400px;">
                                            <table style="width: 100%;">
                                            </table>
                                            <table width="100%">
                                                <tr>
                                                    <td colspan="3" style="font-size: 14px; font-weight: bold; text-align: left; border-bottom: solid 1px Gray;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" __designer:wfdid="w697"
                                                                ControlToValidate="txtAppDate" ErrorMessage="*" Font-Bold="True" Font-Size="Large"
                                                                Height="16px"></asp:RequiredFieldValidator>
                                                        </td>
                                                        <td>
                                                        </td>
                                                        <td style="width: 3px">
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" __designer:wfdid="w698"
                                                                ControlToValidate="txtAppDate" CssClass="validator" ErrorMessage="Invalid" ValidationExpression="^(?=\d)(?:(?:31(?!.(?:0?[2469]|11))|(?:30|29)(?!.0?2)|29(?=.0?2.(?:(?:(?:1[6-9]|[2-9]\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00)))(?:\x20|$))|(?:2[0-8]|1\d|0?[1-9]))([-./])(?:1[012]|0?[1-9])\1(?:1[6-9]|[2-9]\d)?\d\d(?:(?=\x20\d)\x20|$))?(((0?[1-9]|1[012])(:[0-5]\d){0,2}(\x20[AP]M))|([01]\d|2[0-3])(:[0-5]\d){1,2})?$"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtFromDate" runat="server" __designer:wfdid="w699" MaxLength="10"
                                                            ...
                                                            <a href="javascript:NewCal('<%= txtFromDate.ClientID %>','ddmmyyyy')">
                                                                <img alt="Pick a date" height="16" src="../images/cal.gif" style="border-right: 0px;
                                                                    border-top: 0px; border-left: 0px; border-bottom: 0px" width="16" /></a><asp:RequiredFieldValidator
                                                                        ID="RequiredFieldValidator3" runat="server" __designer:wfdid="w747" ControlToValidate="txtFromDate"
                                                        ...
                                                        <td style="width: 3px">
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" __designer:wfdid="w700"
                                                                ControlToValidate="txtFromDate" CssClass="validator" ErrorMessage="Invalid" ValidationExpression="^(?=\d)(?:(?:31(?!.(?:0?[2469]|11))|(?:30|29)(?!.0?2)|29(?=.0?2.(?:(?:(?:1[6-9]|[2-9]\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00)))(?:\x20|$))|(?:2[0-8]|1\d|0?[1-9]))([-./])(?:1[012]|0?[1-9])\1(?:1[6-9]|[2-9]\d)?\d\d(?:(?=\x20\d)\x20|$))?(((0?[1-9]|1[012])(:[0-5]\d){0,2}(\x20[AP]M))|([01]\d|2[0-3])(:[0-5]\d){1,2})?$"
                                                                Width="40px"></asp:RegularExpressionValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtToDate" runat="server" __designer:wfdid="w701" MaxLength="10"
                                                                Width="80px"></asp:TextBox>
                                                            <a href="javascript:NewCal('<%= txtToDate.ClientID %>','ddmmyyyy')">
                                                                <img alt="Pick a date" height="16" src="../images/cal.gif" style="border-right: 0px;
                                                                    border-top: 0px; border-left: 0px; border-bottom: 0px" width="16" /></a><asp:RequiredFieldValidator
                                                                        ID="RequiredFieldValidator4" runat="server" __designer:wfdid="w748" ControlToValidate="txtToDate"
                                                                        ErrorMessage="*" Font-Bold="True"></asp:RequiredFieldValidator>
                                                        </td>
                                                        <td>
                                                            <asp:Panel ID="PanelTo" runat="server">
                                                            </asp:Panel>
                                                        </td>
                                                        <td style="width: 3px">
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" __designer:wfdid="w702"
                                                                ControlToValidate="txtToDate" CssClass="validator" ErrorMessage="Invalid" ValidationExpression="^(?=\d)(?:(?:31(?!.(?:0?[2469]|11))|(?:30|29)(?!.0?2)|29(?=.0?2.(?:(?:(?:1[6-9]|[2-9]\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00)))(?:\x20|$))|(?:2[0-8]|1\d|0?[1-9]))([-./])(?:1[012]|0?[1-9])\1(?:1[6-9]|[2-9]\d)?\d\d(?:(?=\x20\d)\x20|$))?(((0?[1-9]|1[012])(:[0-5]\d){0,2}(\x20[AP]M))|([01]\d|2[0-3])(:[0-5]\d){1,2})?$"
                                                                Width="40px"></asp:RegularExpressionValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            <asp:DropDownList ID="ddlHalfDay" runat="server" __designer:wfdid="w703" AutoPostBack="True"
                                                                CausesValidation="True" CssClass="textlevelleft" OnSelectedIndexChanged="ddlLeaveType_SelectedIndexChanged"
                                                                Width="84px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="txtResumeOn" runat="server" __designer:wfdid="w704" MaxLength="10"
                                                                Width="80px"></asp:TextBox>
                                                            <a href="javascript:NewCal('<%= txtResumeOn.ClientID %>','ddmmyyyy')">
                                                                <img alt="Pick a date" height="16" src="../images/cal.gif" style="border-right: 0px;
                                                                    border-top: 0px; border-left: 0px; border-bottom: 0px" width="16" /></a><asp:RequiredFieldValidator
                                                                        ID="RequiredFieldValidator5" runat="server" __designer:wfdid="w749" ControlToValidate="txtResumeOn"
                                                                        ErrorMessage="*" Font-Bold="True"></asp:RequiredFieldValidator>
                                                        </td>
                                                        <td>
                                                            &nbsp;
                                                        ...
                                                        <td style="width: 3px">
                                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" __designer:wfdid="w705"
                                                                ControlToValidate="txtResumeOn" CssClass="validator" ErrorMessage="Invalid" ValidationExpression="^(?=\d)(?:(?:31(?!.(?:0?[2469]|11))|(?:30|29)(?!.0?2)|29(?=.0?2.(?:(?:(?:1[6-9]|[2-9]\d)?(?:0[48]|[2468][048]|[13579][26])|(?:(?:16|[2468][048]|[3579][26])00)))(?:\x20|$))|(?:2[0-8]|1\d|0?[1-9]))([-./])(?:1[012]|0?[1-9])\1(?:1[6-9]|[2-9]\d)?\d\d(?:(?=\x20\d)\x20|$))?(((0?[1-9]|1[012])(:[0-5]\d){0,2}(\x20[AP]M))|([01]\d|2[0-3])(:[0-5]\d){1,2})?$"
                                                                Width="40px"></asp:RegularExpressionValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Button ID="btnCalculate" runat="server" OnClick="btnCalculate_Click"
                                                                Text="Calculate Days " Visible="False" Width="100px"></asp:Button>
                                                        </td>
                                                        <td>
                                                        </td>
                                                        <td style="width: 3px">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            <asp:Label ID="Label14" runat="server" __designer:wfdid="w708" BackColor="#FF9933"
                                                                CssClass="textlevelcenterfine" Text="Availability" Width="50px"></asp:Label>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:TextBox ID="LAv" runat="server" __designer:wfdid="w710" BorderColor="Transparent"
                                                    ...
                                                    <tr>
                                                        <td class="textlevelshort" colspan="4">
                                                            <asp:Label ID="lblMsg2" runat="server" __designer:wfdid="w712" CssClass="msglabel"
                                                                Width="200px"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="textlevelshort" colspan="4">
                                                            <asp:Label ID="lblMsg3" runat="server" __designer:wfdid="w713" CssClass="msglabel"
                                                                Width="200px"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <cc1:FilteredTextBoxExtender ID="ftbADate" runat="server" ValidChars="/" Enabled="True"
                                                TargetControlID="txtAppDate" FilterType="Custom, Numbers" __designer:wfdid="w722">
                                            </cc1:FilteredTextBoxExtender>
                                            <asp:Label ID="lblLDurInDays" runat="server" __designer:wfdid="w723"></asp:Label>
                                        </div>
                                        <div style="width: 30%; float: left; margin-left: 1%; background-color: #C2D69B;
                                            border: solid 1px Gray; height: 400px;">
                                            <table style="width: 100%;">
                                                <tr>
                                                    <td style="font-size: 14px; font-weight: bold; text-align: left; border-bottom: solid 1px Gray;">
                                                ...
                                                <tr>
                                                    <td class="textlevelleft" style="height: 20px" valign="bottom">
                                                        Reason (In case of TOIL application please mention which date/s and why you have
                                                        worked)
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtLeaveReason" runat="server" Height="94px" MaxLength="1000" TextMode="MultiLine"
                                                ...
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtLeaveAdd" runat="server" Height="94px" MaxLength="150" TextMode="MultiLine"
                                                            Width="98%"></asp:TextBox>
                                                            <%--<asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtLeaveAdd"
                                                    ErrorMessage="*" Font-Bold="True" Width="40px" Height="16px"></asp:RequiredFieldValidator>--%>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="textlevelleft" style="height: 23px" valign="bottom">
                                                        Contact Number
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="txtPhone" runat="server" Height="17px" MaxLength="100" Width="98%"></asp:TextBox>
                                        ...
                                        <table style="width: 100%;">
                                            <tr>
                                                <td style="width: 38%;text-align:left;">
                                                    <asp:Button ID="btnLeaveHistroy" runat="server" CausesValidation="False" OnClick="btnLeaveHistroy_Click"
                                                        Text="Show My Leave History" Width="95%" style="margin-left: -4px !important;"></asp:Button>
                                                </td>
                                                <td style="width: 29%;text-align:center;">
                                                    <asp:Button ID="btnReload" runat="server" CausesValidation="False" OnClick="btnReload_Click"
                                                        Text="Refresh" Width="95%" style="margin-left: -9px !important;"></asp:Button>
                                                </td>
                                ...
                                <asp:Panel ID="pnlEmpList" runat="server">
                                    <fieldset>
                                        ...
                                        <table>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label19" runat="server" CssClass="textlevelcenterfine" Text="Select the employee for whom you want to forward leave application and press Load Employee button "
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Button ID="btnEmpDetails" runat="server" CausesValidation="False" OnClick="btnEmpDetails_Click"
                                                        Text="Load Employee"></asp:Button>
                                                </td>
                                            </tr>
                                        </table>
                                    </fieldset>
                                ...
                                <table>
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <asp:Label ID="lblDept" runat="server" Visible="False" Width="211px"></asp:Label>
                                        </td>
                                        <td style="width: 2px">
                                            <asp:Label ID="Label6" runat="server" CssClass="textlevel" Text="Designation :" Visible="False"></asp:Label>
                                        </td>
                                        <td>
                                            <asp:Label ID="lblDesig" runat="server" Visible="False" Width="211px"></asp:Label>
                                        </td>
                                        <td style="width: 3px">
                                        </td>
                                        <td style="width: 3px">
                                ...
                                &nbsp;&nbsp;<cc1:FilteredTextBoxExtender ID="ftbEmpId" runat="server" Enabled="True"
                        ...
                        <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="TabPanel2">
                            ...
                            <ContentTemplate>
                                <div style="margin: 10px 5px 5px 10px; height: 550px; width: 98%; _width: 97%; overflow: scroll;
                                    ...
                                    <asp:GridView ID="grLeaveApp" runat="server" AutoGenerateColumns="False" OnRowDataBound="grLeaveApp_RowDataBound"
                                     DataKeyNames="LvAppID,AppStatus,LTypeTitle,LTypeId,LNature,AppDate,LeaveStart,LeaveEnd,LDurInDays,InsertedBy,LTReason,EmpId,ResponsiveEmpId,AddrAtLeave,PhoneNo,IsHalfDay,ResumeDate"
                            ...
                            <ContentTemplate>
                                <div style="margin: 10px 5px 5px 10px; height: 550px; width: 98%; _width: 97%; overflow: scroll;
                                    ...
                                    <asp:GridView ID="grLeaveApprove" runat="server" Font-Size="9px" Width="100%" PageSize="7"
                                        ...
                                        AutoGenerateColumns="False" OnRowCommand="grLeaveApprove_RowCommand">
                                        <Columns>
                                            <asp:BoundField HeaderText="SL No.">
                                            ...
                                            <asp:BoundField DataField="LDurInDays" HeaderText="Total Days">
                                                <ItemStyle Width="4%" CssClass="ItemStylecssRight"></ItemStyle>
                                            </asp:BoundField>
                                            <asp:BoundField DataField="UpdatedBy" HeaderText="Approve By">
