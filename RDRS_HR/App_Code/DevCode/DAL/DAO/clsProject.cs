...
public class clsProject
{
    ...
    public clsProject(string strProjectId, string strProjectName,string strShortName, string strProjectCode, string strStartDate, string strEndDate, string strWeekEndID,
         string strIncrementType,string  strIncrementMonth,string strIncrementAfter,string strIsPF,string  strIsGratuity,string strIsEOC,
         string strIsLE, string strIsInsurance, string strIsGSal, string strIsBSal, string strIsCore, string strIsProject,string strIsActive,
