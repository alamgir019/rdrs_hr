...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="PayrollConfigForm2" style="width:50% !important;">
        <div id="formhead1">
                ...
                <cc1:TabPanel runat="server" Height="570px" ID="TabPanel1" HeaderText="Salary Package Setup">
                    <ContentTemplate>
                        <fieldset>
                            ...
                            <asp:HiddenField ID="hfGrossSal" runat="server"></asp:HiddenField>
                            &nbsp;&nbsp;
                        </fieldset>
                                        ...
                                        <table style="width: 98%">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td >
                                                        <asp:TextBox ID="txtGrossSal" runat="server" CssClass="TextBoxAmt80" __designer:wfdid="w70"
