                  ...
                  <td></td>
                   <td></td>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlGeneratefor" runat="server" Width="150px" onchange="SearchByChanged()"
            ...
            <fieldset>
                <div id="PrintMe" style="width: 99.99%; page-break-before: always; height: 100%;">
                    ...
                    <div style="font-family: Arial; font-size: 14px; margin-left: 5px;">
                        <b><asp:Label ID="lblIntervention" runat="server" Text=""></asp:Label></b>
                         <br />
