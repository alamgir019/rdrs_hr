        ...
        <div id="Div950" style="margin-left: 10px; margin-right: 10px;">
                ...
                <fieldset>
                    <table>
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlReligion" runat="server" Width="120px" CssClass="textlevelleft"
                        ...
                        <tr>
                         <td class="textlevelleft">
                            ...
                            <td>
                                <asp:DropDownList ID="ddlEmpType" runat="server" Width="116px" CssClass="textlevelleft"
                                    Height="18px">
                                </asp:DropDownList>
                            </td>
                            <td></td>
            ...
            <fieldset>
                <asp:GridView ID="grEmployee" runat="server" EmptyDataText="No Record Found" Font-Size="9px"
                    Width="98%" AutoGenerateColumns="False" DataKeyNames="JOININGDATE,SeparateDate,EMPTYPEID,VMONTH,VYEAR,FISCALYRID,ISPRORATA,PRCENT">
            ...
            <div id="DivCommand1" style="padding-top: 3px;">
                ...
                <div style="text-align: right;">
                    <asp:Button ID="btnSaveDisburse" runat="server" Text="Save &amp; Disburse" Width="143px"
                        UseSubmitBehavior="False" OnClick="btnSaveDisburse_Click" Style="margin-left: 0px" />
