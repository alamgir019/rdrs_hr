        ...
        <div class="Div950">
                ...
                <table>
                    <tr>
                       ...
                       <td class="textlevel">
                        ...
                        <td>
                            <asp:DropDownList ID="ddlEmpStatus" runat="server" Width="150px" CssClass="textlevelleft">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtPercentage" MaxLength="3" runat="server" Width="80px" Style="text-align: right;">100</asp:TextBox>
            ...
            <div style="border: solid 1px #3E506C;">
                <div style="width: 99%; overflow: scroll; height: 420px;">
                    <asp:GridView ID="grPayslipMst" runat="server" EmptyDataText="No Record Found" Font-Size="9px"
                        ...
                        LateDedASOTDEDHouR,LateDedASOTDEDAMt,SalPakID,PostingPlaceId,BANKCODE,RoutingNo,BankAccNo,DeptId,JobTitleId,EMPTYPEID,PLANACCLINE,SalLocId,SalSubLocId,
                        OfficeID,GradeID,GradeLevelID,EmpNatureId,SectorID,AppointType"
            ...
            <div id="DivCommand1" style="padding-top: 3px;">
                ...
                <div style="text-align: right;">
                    <asp:CheckBox ID="CheckBox1" CssClass="textlevelleft" runat="server" Text="Want to send Email to Verify" />
