                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlIntervention" runat="server" Width="150px" CssClass="textlevelleft"
                                      ...
                                      <asp:CompareValidator ID="CompareValidator4" runat="server" ErrorMessage="*" ControlToValidate="ddlIntervention"
                                ...
                                <td class="textlevel">
                                    Assessment Year :</td>
                                <td>
                                    <asp:TextBox ID="txtAssYear" runat="server" Width="100px" onkeydown="return (!(event.keyCode>=65) && event.keyCode!=32);" MaxLength="4"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="*" ControlToValidate="txtAssYear"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            ...
                            <td class="textlevel">
                                    Employee :</td>
                                <td>
                                    <asp:DropDownList ID="ddlEmployee" runat="server" Width="150px" ></asp:DropDownList></td>
                ...
                <fieldset>
                    ...
                    <div style="margin-top: 10px" id="PrintMe">
                        <asp:GridView ID="grEmployee" runat="server" EmptyDataText="No Record Found" Font-Size="9px"
                            AutoGenerateColumns="False" DataKeyNames="EMPID,SALARYPAKID,PostingDivId,DEPTID,Staffname,Designation,TIN"
