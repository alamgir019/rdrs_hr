...
<body>
    <div id="wrapper">
        <div id="header">
            <div id="banner">
                <div id="ide">
                    <img src="Images/RDRS_logo.png" width="268px" height="60px" alt="" />
                </div>
                <div id="company">
                    <div id="companyName">
                        HR & Payroll System
        ...
        <div id="mainContent">
            <div class="row">
                ...
                <div class="login-div" style="margin-top: 50px;">
                    <div class="loginbox radius" style="background-color: #293955;">
    ...
    <div id="footer">
        <div class="copyright">
            Copyright &copy <a href="http://www.baseltd.com/">BASE Limited</a></div>
    </div>
</body>
</html>
