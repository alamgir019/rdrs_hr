                    ...
                    <asp:TreeView ID="tvReports" runat="server" ImageSet="Arrows" OnSelectedNodeChanged="tvReports_SelectedNodeChanged">
                        <Nodes>
                            <asp:TreeNode Text="Report List" Value="RL">
                                ...
                                <asp:TreeNode Text="Development Plan(Priority List)" Value="DP"></asp:TreeNode>                              
                                ...
                                <asp:TreeNode Text="Consultant Reports" Value="CR">
                                <asp:TreeNode Text="Consultant Information with Payment" Value="CIWP"></asp:TreeNode>
                                <asp:TreeNode Text="Consultant Overall Information" Value="COI"></asp:TreeNode>
                                </asp:TreeNode> 
                            </asp:TreeNode>
                        </Nodes>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <asp:DropDownList ID="ddlGroupWise" runat="server" Width="230px" CssClass="textlevelleft"
                                                                            ...
                                                                            <asp:ListItem Value="7">Intervention Wise Employee List</asp:ListItem>
                                                                            <asp:ListItem Value="1">Grade Wise Employee List</asp:ListItem>
                                                                            <asp:ListItem Value="2">Sector Wise Employee List</asp:ListItem>
                                                                            <asp:ListItem Value="3">Component/Unit Wise Employee List</asp:ListItem>
                                                                            <asp:ListItem Value="4">Position By Function Wise Employee List</asp:ListItem>
                                                                            ...
                                                                            <asp:ListItem Value="11">Program/Dept Employee List</asp:ListItem>
                                                    ...
                                                    <asp:Panel ID="PSector" runat="server" BorderStyle="Solid" BorderColor="DarkGray"
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label1" runat="server" Text="Sector:" Width="150px" CssClass="textlevel"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <asp:Panel ID="PProgDept" runat="server" BorderStyle="Solid" BorderColor="DarkGray"
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label7" runat="server" Text="Program/Department :" Width="150px" CssClass="textlevel"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <asp:Panel ID="PCompUnit" runat="server" BorderStyle="Solid" BorderColor="DarkGray"
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label8" runat="server" Text="Component/Unit :" Width="150px" CssClass="textlevel"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <asp:Panel ID="PPosByFunc" runat="server" BorderStyle="Solid" BorderColor="DarkGray"
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label13" runat="server" Text="Position By Function :" Width="150px"
                                                                            CssClass="textlevel"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <asp:Panel ID="PSalaryLoc" runat="server" BorderStyle="Solid" BorderColor="DarkGray"
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="LabelSalaryLocation" runat="server" Text="Salary Location :" Width="150px"
                                                                            CssClass="textlevel"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <asp:Panel ID="PPlaceOfPosting" runat="server" BorderColor="DarkGray" BorderStyle="Solid"
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label16" runat="server" CssClass="textlevel" Text="Place Of Posting :"
                                                                            Width="150px"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                                        <asp:DropDownList ID="ddlPlaceOfPosting" runat="server" CssClass="textlevelleft"
                                                                            Width="150px">
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                </tr>
