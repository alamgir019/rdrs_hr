                        ...
                        <Nodes>
                            <asp:TreeNode Text="Payroll Report List" Value="RL">
                                <asp:TreeNode Text="Salary" Value="SR">
                                    ...
                                    <asp:TreeNode Text="Salary Sheet without Charging" Value="SSS"></asp:TreeNode>
                                    ...
                                    <asp:TreeNode Text="Employee Salary Certificate" Value="SC"></asp:TreeNode>
                                </asp:TreeNode>
                                ...
                                <asp:TreeNode Text="Bank Statement for Finance " Value="BSFF"></asp:TreeNode>
                        ...
                        <ContentTemplate>
                            <table style="width: 340px;">
                                <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <asp:DropDownList ID="ddlReportBy" runat="server" Width="127px" CssClass="textlevelleft"
                                                                    ...
                                                                    <asp:ListItem Value="D">Salary Division</asp:ListItem>
                                            ...
                                            <asp:Panel ID="PBranch" runat="server" BorderStyle="Solid" BorderColor="DarkGray"
                                                ...
                                                <table>
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="Label1" runat="server" Text="Office :" Width="100px" CssClass="textlevel"></asp:Label>
                                                            </td>
                                                            <td colspan="2">
                                                    ...
                                                    <asp:Panel ID="pIntervention" runat="server" BorderStyle="Solid" BorderColor="DarkGray"
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label26" runat="server" Text="Intervention :" Width="150px" CssClass="textlevel"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <asp:Panel ID="pOfficeType" runat="server" BorderStyle="Solid" BorderColor="DarkGray"
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label27" runat="server" Text="Office Type :" Width="150px" CssClass="textlevel"></asp:Label>
                                                                    </td>
                                                                    <td>
                                                    ...
                                                    <asp:Panel ID="pOffice" runat="server" BorderStyle="Solid" BorderColor="DarkGray"
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <asp:Label ID="Label28" runat="server" Text="Office :" Width="150px" CssClass="textlevel"></asp:Label>
                                                                    </td>
                                                                    <td>
                                            ...
                                            <asp:Panel ID="P_ComText" runat="server" BorderColor="DarkGray" BorderStyle="Solid"
                                                ...
                                                <table>
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <asp:Label ID="lblCommon" runat="server" CssClass="textlevel" Text="" 
                                                                    Width="100px"></asp:Label>
                                                            </td>
                                                            <td>
                                                                        ...
                                                                        <td>
                                                                            <div style="border-right: black 1px solid; border-top: black 1px solid; margin: 15px 0px 0px;
                                                                                ...
                                                                                <asp:GridView ID="grSalDivision" runat="server" Font-Size="9px" EmptyDataText="No Record Found"
                                                                                    AutoGenerateColumns="False" DataKeyNames="SalSubLocId" Width="260px">
                                                                                    ...
                                                                                    <Columns>
                                                                                        ...
                                                                                        <asp:BoundField DataField="SalSubLocId" HeaderText="Salary Division ID">
                                                                                            <ItemStyle CssClass="ItemStylecss" Width="40%"></ItemStyle>
                                                                                        </asp:BoundField>
                                                                                        <asp:BoundField DataField="SalSubLocName" HeaderText="Salary Division Name">
                                    ...
                                    <tr>
                                        <td>
                                            <asp:Panel ID="P_Date" runat="server" BorderStyle="Solid" BorderColor="DarkGray" BorderWidth="1px"
                                                Width="420px" Visible="False">
                                                <table>
                                                    <tbody>
                                                        <tr>
