...
<asp:Content ID="MainContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="setup">
            ...
            <fieldset>
                ...
                <table>
                    ...
                    <tr>
                     ...
                     <tr>
                        <td>
                            <asp:Label ID="Label5" runat="server" Width="100px" CssClass="textlevel" Text="Clinic Type :"></asp:Label>
                        </td>
                        <td>
        ...
        <div class="GridFormat1">
            ...
            <asp:GridView ID="grClinic" runat="server" DataKeyNames="ClinicId,IsActive,ClinicTypeId"
