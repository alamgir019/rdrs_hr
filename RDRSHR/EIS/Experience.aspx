    ...
    <div class="empTrainForm">
        ...
        <div id="PayrollConfigInner" style="height:350px ">
            ...
            <fieldset style="margin-bottom: 10px;">
                ...
                <table>
                    <tr>
                        <td class="textlevel">
                            Job Title :</td>
                        <td>
                            <asp:TextBox ID="txtJobTitle" runat="server" MaxLength="200" 
                    ...
                    <tr>
                        <td class="textlevel">
                            Company Name :</td>
                        <td>
                            <asp:TextBox ID="txtCompany" runat="server" MaxLength="400"
                                ToolTip="Enter the Emp. Code and click on Find Button. Details of the find employee will be shown in employee general information screen if information exists. In order to enter employee."
                                Width="292px"></asp:TextBox></td>
                    </tr>
                    <tr>
                   ...
                   <%-- <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtResponse" runat="server" MaxLength="500" 
                                ToolTip="Enter the Emp. Code and click on Find Button. Details of the find employee will be shown in employee general information screen if information exists. In order to enter employee."
                                Width="292px" TextMode="MultiLine" Rows="3"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td class="textlevel">
                        </td>
                        <td>
                            <asp:CheckBox ID="chkIsSC" runat="server" CssClass="textlevelleft" Text="Is RDRS Experience"
                                Width="150px" />
             ...
             <fieldset><legend>Resume Link</legend> 
                <table>
                    <tr>
                        <td class="textlevelcenter">Applicant Id</td>
                    </tr>
                    <tr>
                        <td class="textlevelcenter">
                            <asp:TextBox ID="TextBox7" runat="server" MaxLength="20" Width="80px"></asp:TextBox></td>
                    </tr>
                    <tr>
                        <td class="textlevelcenter">
                            <asp:Button ID="Button1" runat="server" CausesValidation="False" Text="Load Info"
                    Width="80px" ToolTip="Click on Save Button to store the employee data." /></td>
                    </tr>
                </table>
