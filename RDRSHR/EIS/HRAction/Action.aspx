                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtDescription" runat="server" Width="250px" TextMode="MultiLine"
                            Rows="3" ToolTip="This is an optional value. If you want to keep some notes about this action setup."></asp:TextBox>                            
                            </td>
                    <td>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlActionNature" runat="server" CssClass="textlevelleft" Width="255px">
                            ...
                            <asp:ListItem Value="H">Suspension Held Up</asp:ListItem>                            
                        </asp:DropDownList></td>
                    <td>
                    </td>
                </tr>
