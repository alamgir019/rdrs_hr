        ...
        <div style="margin: 5px 10px 10px 10px;">
            <div class="Div920">
                <fieldset>
                    ...
                    <table>
                        ...
                        <tr>
                            <td class="textlevelleft" style="height: 15px">
                               Addl/In-Charge Designation :</td>
                            <td class="textlevelleft" style="height: 15px">
                            <asp:DropDownList ID="ddlFuncDesignation" runat="server" CssClass="textlevelleft" Width="300px"
                                >
                            </asp:DropDownList></td>
                        </tr>
                        <tr>
                        ...
                        <tr style="display:none;">
                            ...
                            <td>
                                <asp:TextBox ID="txtPercent" runat="server" MaxLength="5" 
                                    CssClass="TextBoxAmt60" Text="0"></asp:TextBox>&nbsp;<asp:Button 
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:CheckBox ID="chkIsResponseAllowance" runat="server" 
                                    CssClass="textlevelleft" Text="Is Allowance Applicable"
                                    Width="150px" />
            ...
            <div id="empEduDiv02" style="height: 200px;">
                <asp:GridView ID="grAddResponsibility" runat="server" 
                    AutoGenerateColumns="False" DataKeyNames="AddResponseId,JobTitleId"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="EntryDate" HeaderText="Entry Date">
                         ...
                         <asp:BoundField DataField="JobTitleName" HeaderText="Functional Designation">
                            <ItemStyle CssClass="ItemStylecss" Width="10%" />
                        </asp:BoundField>
