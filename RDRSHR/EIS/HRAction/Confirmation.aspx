                ...
                <table>
                    ...
                    <tr>
                        <td class="textlevel">
                            Extension (Months) :</td>
                        <td>
                            <asp:TextBox ID="txtExtensionMonth" runat="server" CssClass="TextBoxAmt60" 
                                MaxLength="20" Width="80px" ontextchanged="txtExtensionMonth_TextChanged"></asp:TextBox></td>
                    </tr>
                     <tr>
                        <td class="textlevel">
                            New Confirmation Date :</td>
                        <td>
                            <asp:TextBox ID="txtNewConfirmDate" runat="server" Width="80px" ReadOnly="True"></asp:TextBox>
                            </td>
                    </tr>                   
                    <tr>
                        <td class="textlevel">
                ...
                <div style="overflow: scroll; width: 100%; height: 250px">
                    <asp:GridView ID="grConfirmation" runat="server" Width="100%" Font-Size="9px" EmptyDataText="No Record Found"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="NewConfirmDate" HeaderText="New Confirm Date">
