        ...
        <fieldset>
          <div style="background-color:Gray;text-align:center;">
            ...
            <asp:Button ID="btnExport" runat="server" Font-Bold="true" Height="30px"
              ...
              <asp:Button ID="btnReport" runat="server" Text="Show Crystal Report" Width="200px" Height="30px" OnClick="btnReport_Click" CausesValidation="False"/>
          ...
          <div id="PrintMe" style="width:100%;margin-top:5px;"> <span style="font-size:16px;font-weight:bold;">Monthly Provident Fund Ledger</span> <br />
            ...
            <table style="width:100%;border-collapse:collapse;border:solid 1px Black;">
              <tr>
                ...
                <td style="text-align:center;border:solid 1px Black;width:20%;" colspan="4">Current Months Credit</td>
              ...
              <tr>
                ...
                <td style="text-align:center;border:solid 1px Black; height: 17px;" >CARE</td>
                ...
                <td style="text-align:center;border:solid 1px Black; height: 17px;" >Interest</td>
                <td style="text-align:center;border:solid 1px Black; height: 17px;" >Total</td>
                <td style="text-align:center;border:solid 1px Black; height: 17px;" >Date</td>
                <td style="text-align:center;border:solid 1px Black; height: 17px;" >Amount</td>
                <td style="text-align:center;border:solid 1px Black; height: 17px;" >OWN</td>
                <td style="text-align:center;border:solid 1px Black; height: 17px;" >CARE</td>
                <td style="text-align:center;border:solid 1px Black; height: 17px;" >Interest</td>
                <td style="text-align:center;border:solid 1px Black; height: 17px;" >Total</td>
              ...
              <asp:Repeater ID="rptPFLedger" runat="server">
                <ItemTemplate>
                  <tr >
                    ...
                    <td style="text-align:right;"><%#Convert.ToString(Eval("CMPFOWN"))%></td>
                    <td style="text-align:right;"><%#Convert.ToString(Eval("CMPFCARE"))%></td>
                    <td style="text-align:right;"><%#Convert.ToString(Eval("CMPFINTREST"))%></td>
                    <td style="border-right:solid 1px Black;text-align:right;"><%#Convert.ToString(Eval("CMTOTAL"))%></td>
                    ...
                    <td style="text-align:right;"><%#Convert.ToString(Eval("CUPFOWN"))%></td>
                    <td style="text-align:right;"><%#Convert.ToString(Eval("CUPFCARE"))%></td>
                    <td style="text-align:right;"><%#Convert.ToString(Eval("CUPFINTREST"))%></td>
                    <td style="border-right:solid 1px Black;text-align:right;"><%#Convert.ToString(Eval("CUTOTAL"))%></td>
              ...
              <asp:Repeater ID="rptPFLedgerSummary" runat="server">
                <ItemTemplate>
                  <tr style="border:solid 1px black;">
                    ...
                    <td style="text-align:right;border:solid 1px black;"><%#Convert.ToString(Eval("CMPFOWN"))%></td>
                    <td style="text-align:right;border:solid 1px black;"><%#Convert.ToString(Eval("CMPFCARE"))%></td>
                    <td style="text-align:right;border:solid 1px black;"><%#Convert.ToString(Eval("CMPFINTREST"))%></td>
                    <td style="border-right:solid 1px Black;text-align:right;border:solid 1px black;"><%#Convert.ToString(Eval("CMTOTAL"))%></td>
                    ...
                    <td style="text-align:right;border:solid 1px black;"><%#Convert.ToString(Eval("CUPFOWN"))%></td>
                    <td style="text-align:right;border:solid 1px black;"><%#Convert.ToString(Eval("CUPFCARE"))%></td>
                    <td style="text-align:right;border:solid 1px black;"><%#Convert.ToString(Eval("CUPFINTREST"))%></td>
                    <td style="border-right:solid 1px Black;text-align:right;border:solid 1px black;"><%#Convert.ToString(Eval("CUTOTAL"))%></td>
