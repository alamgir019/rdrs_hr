                            ...
                            <div style="width: 100%; overflow: scroll; height: 400px;">
                                <asp:GridView ID="grAttendance" runat="server" EmptyDataText="No Record Found" Font-Size="9px"
                                    ...
                                    <Columns>
                                        ...
                                        <%--<asp:BoundField DataField="" HeaderText="Attn. Days" HeaderStyle-HorizontalAlign="Center">
                                        ...
                                        <asp:BoundField DataField="" HeaderText="P" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle CssClass="ItemStylecssCenter" Width="3%"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField DataField="" HeaderText="A" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle CssClass="ItemStylecssCenter" Width="3%"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField DataField="" HeaderText="W" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle CssClass="ItemStylecssCenter" Width="3%"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField DataField="" HeaderText="WP" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle CssClass="ItemStylecssCenter" Width="3%"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField DataField="" HeaderText="H" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle CssClass="ItemStylecssCenter" Width="3%"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField DataField="" HeaderText="HP" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle CssClass="ItemStylecssCenter" Width="3%"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField DataField="" HeaderText="TV" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle CssClass="ItemStylecssCenter" Width="3%"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField DataField="" HeaderText="Leave" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle CssClass="ItemStylecssCenter" Width="3%"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField DataField="" HeaderText="LWP" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle CssClass="ItemStylecssCenter" Width="3%"></ItemStyle>
                                        </asp:BoundField>
                                        <asp:BoundField DataField="" HeaderText="Irregular" HeaderStyle-HorizontalAlign="Center">
                                            <ItemStyle CssClass="ItemStylecssCenter" Width="3%"></ItemStyle>
                                        </asp:BoundField>
                                    </Columns>
                                </asp:GridView>
