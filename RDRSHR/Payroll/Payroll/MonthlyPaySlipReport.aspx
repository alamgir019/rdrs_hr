...
<body>
    ...
    <div style="width: 60%;">
        <table style="width: 30%;">            
            <tr>
                <td><img src="../../Images/ide-logo.png" alt="" 
                        style="height: 36px; width: 252px" /></td>
            </tr>
            <tr>
    ...
    <div style="margin-top: 20px; font-size: 14px; font-family: Tahoma;" >
     <table style="width: 70%;">
        ...
        <tr>
            <td>Posting Place</td>
            <td>:</td>
            <td> <asp:Label ID="lblPostPla" runat="server" Text="" /></td>
            <td>Salary Division</td>
            <td>:</td>
            <td> <asp:Label ID="lblSalDiv" runat="server" Text="" /></td>
        </tr>
     </table>
    </div>
    <div style="width: 90%;">
