...
<asp:Content ID="MainContent" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="EmpLeaveProfStyle">
        ...
        <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Height="350px">
            <cc1:TabPanel ID="TabPanel1" runat="server" HeaderText="Create User" Height="330px">
                <ContentTemplate>
                    <div class="iesEmp">
                        <fieldset>
                            <!--Div for Controls-->
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox ID="chkIsActive" runat="server" CssClass="textlevelleft" Text="Make The Account Disable">
                                        </asp:CheckBox>
                                    </td>
                                    <td>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:CheckBox ID="chkIsAdmin" runat="server" CssClass="textlevelleft" Text="Admin User">
                                        </asp:CheckBox>
                                    </td>
                                    <td>
                                    </td>
            ...
            <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="User List" Height="330px">
                <ContentTemplate>
                    <table>
                        <tr>
                            <td>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlIntervention" runat="server" Width="210px" CssClass="textlevelleft">
                                </asp:DropDownList>
                            </td>
                            <td>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:DropDownList ID="ddlOffice" runat="server" Width="300px" CssClass="textlevelleft">
                                </asp:DropDownList>
                            </td>
                            <td>
