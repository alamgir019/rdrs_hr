 ...
 <cc1:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="100%"
    ...
    <ContentTemplate>  
        ...
        <div class="officeSetupInner">
            ...
            <fieldset>
              <table>
                    ...
                    <tr>
                     <td> <asp:Label ID="Label7" runat="server" CssClass="textlevel" Text="Employee Name :"></asp:Label></td>
                     <td> <asp:DropDownList ID="ddlTraineeName" runat="server" CssClass="textlevelleft" Width="200px"
                                ToolTip="Select" OnSelectedIndexChanged="ddlTraineeName_SelectedIndexChanged" AutoPostBack="true">
                            </asp:DropDownList></td>
                        <td></td>
                         <td><asp:Label ID="Label23" runat="server" CssClass="textlevel" Text="Designation :"></asp:Label></td>
                     <td><asp:TextBox ID="txtDesignation" runat="server" Width="200px" ReadOnly="True"></asp:TextBox></td>                
                    </tr>
                     <tr>                        
                    <td><asp:Label ID="Label24" runat="server" CssClass="textlevel" Text="Dept :"></asp:Label></td>
                     <td><asp:TextBox ID="txtDept" runat="server" Width="200px" ReadOnly="True"></asp:TextBox></td> 
                      <td></td><td></td>
        ...
        <div class="GridFormat1">
            ...
            <asp:GridView ID="grList" runat="server" DataKeyNames="TraineeId,TraineeName,Designation,Dept" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="Dept" HeaderText="Dept/Clinic">
                        <ItemStyle CssClass="ItemStylecssCenter" Width="10%"></ItemStyle>
                    </asp:BoundField>
                </Columns>
            </asp:GridView>
