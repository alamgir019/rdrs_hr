...
public partial class Training_TrainingList : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            Common.FillDropDownList_Nil(objTrMgr.SelectLocation("0"), ddlLocation);
           // Common.FillDropDownList(objSOFMgr.SelectProjectList(0), ddlFundedby, "ProjectName", "ProjectId", false);
    ...
    private void SaveData(string cmdType)
    {
        ...
        foreach(DataRow row in dtDtlInput.Rows)
        {
            ...
            nRowdtl["FundType"] = row["FundType"].ToString().Trim();

            if (row["FundType"].ToString().Trim() == "P")
            {
                nRowdtl["ProjectId"] = row["Fundedby"].ToString().Trim();
            }
            else
            {
                nRowdtl["ProjectId"] = DBNull.Value;
            }
            if (row["FundType"].ToString().Trim() == "D")
            {
                nRowdtl["ProjectDonar"] = row["Fundedby"].ToString().Trim();
            }
            else
            {
                nRowdtl["ProjectDonar"] = DBNull.Value;
            }
            ...
            case ("DoubleClick"):
                {
                  ...
                  // ddlFundedby.SelectedValue = grList.DataKeys[_gridView.SelectedIndex].Values[4].ToString();
                    if (grList.DataKeys[_gridView.SelectedIndex].Values[7].ToString().Trim() == "P")
                    {
                        ...
                        {
                            ListItem item = ddlProject.Items.FindByValue(grList.DataKeys[_gridView.SelectedIndex].Values[4].ToString());
                            if (item != null)
                                ddlProject.SelectedValue = grList.DataKeys[_gridView.SelectedIndex].Values[4].ToString();
                        }
                    }
                    else if (grList.DataKeys[_gridView.SelectedIndex].Values[7].ToString().Trim() == "D")
                    {
                        ...
                        {
                            ListItem item = ddlProjectDonar.Items.FindByValue(grList.DataKeys[_gridView.SelectedIndex].Values[4].ToString());
                            if (item != null)
                                ddlProjectDonar.SelectedValue = grList.DataKeys[_gridView.SelectedIndex].Values[4].ToString();
                        }
                    }
    ...
    {
        //TraineeId,TraineeName,Designation,Dept,Fundedby,ProjectName,IsResidential,FundType
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        if (ddlFundType.SelectedValue.ToString().Trim() == "P")
            dt.Rows.Add(ddlTraineeName.SelectedValue.ToString().Trim(), ddlTraineeName.SelectedItem.Text.ToString().Trim(), txtDesignation.Text.ToString(), txtDept.Text.ToString(), ddlProject.SelectedValue.ToString().Trim(), ddlProject.SelectedItem.ToString().Trim(),chkIsResidential.Checked == true ? "N" : "Y", ddlFundType.SelectedValue.ToString().Trim());
        else if (ddlFundType.SelectedValue.ToString().Trim() == "D")
            dt.Rows.Add(ddlTraineeName.SelectedValue.ToString().Trim(), ddlTraineeName.SelectedItem.Text.ToString().Trim(), txtDesignation.Text.ToString(), txtDept.Text.ToString(), ddlProjectDonar.SelectedValue.ToString().Trim(), ddlProjectDonar.SelectedItem.ToString().Trim(), chkIsResidential.Checked == true ? "N" : "Y", ddlFundType.SelectedValue.ToString().Trim());
