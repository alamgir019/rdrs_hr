<%@ Page Title="" Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true" CodeFile="TrainingList.aspx.cs" Inherits="Training_TrainingList" %>
        ...
        <div class="officeSetupInner">
               ...
               <asp:HiddenField ID="hfIsUpdate" runat="server" />
                <table>
                     <tr>
                        ...
                        <td style="height: 22px">
                            <asp:CheckBox ID="chkIsSchedule" runat="server" CssClass="textlevelleft" 
                                Text="Is Schedule" Checked="True" Enabled="False" />
                        </td>
                        <td style="height: 22px">
                        </td>
                        <td style="height: 22px">
                    ...
                    <tr>
                        ...
                        <td> <asp:Label ID="Label4" runat="server" CssClass="textlevel" Text="Schedule Name :"></asp:Label>
                        </td>
                        <td> 
                           <asp:DropDownList ID="ddlSchedule" runat="server" CssClass="textlevelleft" Width="200px"
                                ToolTip="Select" OnSelectedIndexChanged="ddlSchedule_SelectedIndexChanged" 
                                AutoPostBack="True">
                            </asp:DropDownList>
                        </td> 
                    </tr>
                     <tr>
                     <td><asp:Label ID="Label10" runat="server" CssClass="textlevel" Text="Start Date :"></asp:Label>
                     </td>
                     <td><asp:TextBox ID="txtStrDate" runat="server" Width="89px" ReadOnly="True"></asp:TextBox>
                     </td>
                     <td><asp:Label ID="Label11" runat="server" CssClass="textlevel" Text="End Date :"></asp:Label>
                     </td>
                     <td>
                    ...
                    <tr>
                     <td><asp:Label ID="Label9" runat="server" CssClass="textlevel" Text="Duration :"></asp:Label>
                     </td>
                     <td><asp:TextBox ID="txtDuration" runat="server" Width="150px"  ReadOnly="True"></asp:TextBox>
                     </td>
                     <td><asp:Label ID="Label12" runat="server" CssClass="textlevel" Text="No Of Person :"></asp:Label>
                     </td>
                     <td><asp:TextBox ID="txtNoOfPerson" runat="server" Width="150px"  ReadOnly="True"></asp:TextBox>
                    </td>
                    </tr>
                     <tr>
                     <td> <asp:Label ID="Label25" runat="server" CssClass="textlevel" Text="Location Name :"></asp:Label>
                     </td>
                     <td><asp:DropDownList ID="ddlLocation" runat="server" CssClass="textlevelleft" Width="200px"
                                ToolTip="Select" ></asp:DropDownList>
                     </td>
                     <td><asp:Label ID="Label17" runat="server" CssClass="textlevel" Text="Organised By :"></asp:Label>
                     </td>
                     <td><asp:DropDownList ID="ddlOrganisedBy" runat="server" CssClass="textlevelleft" Width="200px"
                                ToolTip="Select" ></asp:DropDownList>
                     </td>           
                    </tr>
                </table>
            ...
            <br />
             <fieldset>
              ...
              <table>
                    <tr>
                     <td><asp:Label ID="Label18" runat="server" CssClass="textlevel" Text="Venue :"></asp:Label>
                     </td>
                     <td> <asp:DropDownList ID="ddlVenue" runat="server" CssClass="textlevelleft" Width="200px" OnSelectedIndexChanged="ddlVenue_SelectedIndexChanged"
                              AutoPostBack="true"  ToolTip="Select Training Name"></asp:DropDownList>
                     </td>                    
                     <td></td>  
                     <td><asp:Label ID="Label19" runat="server" CssClass="textlevel" Text="Address :"></asp:Label>
                     </td>
                     <td><asp:TextBox ID="txtAddress" runat="server" Width="150px" ReadOnly="True"></asp:TextBox>
                     </td>
                    </tr>
                    <tr>
                    
                      <td><asp:Label ID="Label20" runat="server" CssClass="textlevel" Text="Date :"></asp:Label>
                      </td>
                      <td><asp:TextBox ID="txtDate" runat="server" Width="89px"></asp:TextBox>
                     ...
                     <a href="javascript:NewCal('<%= txtDate.ClientID %>','ddmmyyyy')">
                      ...
                      <td><asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtDate" ErrorMessage="*"></asp:RequiredFieldValidator>
                        </td>
                     
                     <td><asp:Label ID="Label22" runat="server" CssClass="textlevel" Text="Time :"></asp:Label>
                     </td>
                     <td>
                    <cc2:TimeSelector ID="tsTime" runat="server" DisplaySeconds="False" 
                             onkeydown = "return (!(event.keyCode>=65) && event.keyCode!=32);" AmPm="PM" 
                             BorderColor="Silver" Date="01/01/0001 12:00:00" Hour="12" Minute="00" Second="00" 
            ...
            <br />
             <fieldset>
              <table>
                    <tr>
                     <td> <asp:Label ID="Label1" runat="server" CssClass="textlevel" Text="Employee Name :"></asp:Label>
                     </td>
                     <td> <asp:DropDownList ID="ddlTraineeName" runat="server" CssClass="textlevelleft" Width="200px"
                                ToolTip="Select" 
                             OnSelectedIndexChanged="ddlTraineeName_SelectedIndexChanged" 
                             AutoPostBack="True">
                            </asp:DropDownList>
                        </td>
                     <td><asp:Label ID="Label23" runat="server" CssClass="textlevel" Text="Designation :"></asp:Label>
                        </td>
                     <td><asp:TextBox ID="txtDesignation" runat="server" Width="150px" ReadOnly="True"></asp:TextBox>
                     ...
                     <tr>    
                    <td><asp:Label ID="Label24" runat="server" CssClass="textlevel" Text="Department :"></asp:Label>
                     </td>
                     <td><asp:TextBox ID="txtDept" runat="server" Width="150px" ReadOnly="True"></asp:TextBox>
                     </td>                      
                     <td><asp:Label ID="Label15" runat="server" CssClass="textlevel" Text="Fund Type :"></asp:Label>
                     </td>
                    ...
                    <tr>
                        <td> <asp:Label ID="Label13" runat="server" CssClass="textlevel" Text="project Name :"></asp:Label></td>
                         ...
                         <td> <asp:Label ID="Label14" runat="server" CssClass="textlevel" Text="Donar Name :"></asp:Label></td>
         ...
         <div class="GridFormat1">
            ...
            <asp:GridView ID="grList" runat="server" DataKeyNames="TraineeId,TraineeName,Designation,Dept,Fundedby,ProjectName,IsResidential,FundType" AutoGenerateColumns="False"
         ...
         <table>
                    <tr>
                     ...
                     <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlSignBy3" runat="server" CssClass="textlevelleft" Width="200px"
                                ToolTip="Select Training Name"></asp:DropDownList>
                        </td>
                        <td>
                        ...
                        <td><asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtCC" ErrorMessage="*"></asp:RequiredFieldValidator>
                         </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td colspan="3">
                            <asp:TextBox ID="txtAdminGuideline" runat="server" Width="470px" ></asp:TextBox>
                        </td> 

                        <td><asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="txtAdminGuideline" ErrorMessage="*"></asp:RequiredFieldValidator>
                        </td>                      
                    </tr>
          </table>
 ...
 <cc1:TabPanel ID="TabPanel2" runat="server" HeaderText="TabPanel1" Width="860px"
    ...
    <ContentTemplate>
        <div class="GridFormat3">
            <!--Grid view Code starts-->
            <asp:GridView ID="grTrainingListSetup" runat="server" DataKeyNames="TrainListId,TrainId,TrainName,ScheduleID,ScheduleName,VenueId,VenueName,VenueAddress,onDate,onTime,SignBy1,SignBy1Name,SignBy2,SignBy2Name,SignBy3,SignBy3Name,CC,AdminGuideline,OrganizedBy,OrganizedByName,IsActive" AutoGenerateColumns="False"
                EmptyDataText="No Record Found" Font-Size="9px" Width="99%" OnRowCommand="grTrainingListSetup_RowCommand" >
