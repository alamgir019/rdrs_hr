<%@ Page Language="C#" MasterPageFile="~/MasterBTMS.master" AutoEventWireup="true"
    CodeFile="Event.aspx.cs" Inherits="Training_Event" Title="Training Event " %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="officeSetup">
        ...
        <div class="officeSetupInner">
            <fieldset>
                ...
                <table>
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" CssClass="textlevel" Text="Event Type"></asp:Label></td>
                        <td>
        ...
        <div class="GridFormat1">
            ...
            <asp:GridView ID="grDivision" runat="server" DataKeyNames="EventId,IsActive" AutoGenerateColumns="False"
